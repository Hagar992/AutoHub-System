    ...
    public class OrdersController :  BaseController
    {
        ...
        public IActionResult Index()
        {
            var orders = _context.Orders
                ...
                .Select(o => new OrderDashbardVM
                {
                    ...
                    TotalPrice = CalculateTotalPrice(o.Status, o.PriceWhenBook, o.DepositePolicy.DepositeRate),
                    Car = $"{o.Car.Brand} {o.Car.Model}",
                    PolicyRate = o.DepositePolicy.DepositeRate
                })
       ...
       [HttpPost]
        ...
        public async Task<IActionResult> Confirm(int id)
        {
            ...
            order.TotalPrice = order.PriceWhenBook;
        ...
        public async Task<IActionResult> Cancel(int id)
        {
            ...
            order.TotalPrice = order.PriceWhenBook * (float)order.DepositePolicy.DepositeRate;
